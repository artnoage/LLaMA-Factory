...
def generate_grid(name, min_width=3, max_width=20, min_height=3, max_height=20, relationship=None):
    ...
    if relationship:
        grid = relationship.apply(grid)
        tag = f"generated by grid {name} using relationship {relationship.__class__.__name__} with color {relationship.color}"
    else:
        tag = "random grid"
